...
namespace LogBook.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,CreatedOn")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,CreatedOn")] Lesson lesson)
        {
            if (id != lesson.Id)
            {
                return NotFound();
